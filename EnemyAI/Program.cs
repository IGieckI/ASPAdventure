...
namespace EnemyAI
{
    class Program
    {
        ...
        public static void CreateModel()
        {
            ...
            // Creo una pipeline che mi permette di "convertire" i dati dal formato che gli passo io a qualcosa che l'IA possa comprendere
            // Creo una pipeline che concatena diverse colonne di input(definite nella classe input) in una nuova colonna di output
        ...
        static void Main(string[] args)
        {
            ...
            //Testo il modello 
            var risultato = PredictionEngine.Value.Predict(sampleData);
